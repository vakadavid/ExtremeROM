...
if $SOURCE_SUPPORT_HOTSPOT_DUALAP; then
    if ! $TARGET_SUPPORT_HOTSPOT_DUALAP; then
        ...
        APPLY_PATCH "system" "system/framework/semwifi-service.jar" "$SRC_DIR/unica/patches/product_feature/wifi/semwifi-service.jar/0002-Disable-DualAP-support.patch"        APPLY_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk" "$SRC_DIR/unica/patches/product_feature/wifi/SecSettings.apk/0002-Disable-DualAP-support.patch"        LOG_STEP_OUT    fifiif $SOURCE_SUPPORT_HOTSPOT_WPA3; then    if ! $TARGET_SUPPORT_HOTSPOT_WPA3; then        LOG_STEP_IN "- Applying Hotspot WPA3 patches"        APPLY_PATCH "system" "system/framework/semwifi-service.jar" "$SRC_DIR/unica/patches/product_feature/wifi/semwifi-service.jar/0003-Disable-Hotspot-WPA3-support.patch"        LOG_STEP_OUT    fifiif $SOURCE_SUPPORT_HOTSPOT_6GHZ; then    if ! $TARGET_SUPPORT_HOTSPOT_6GHZ; then        LOG_STEP_IN "- Applying Hotspot 6GHz patches"        APPLY_PATCH "system" "system/framework/semwifi-service.jar" "$SRC_DIR/unica/patches/product_feature/wifi/semwifi-service.jar/0004-Disable-Hotspot-6GHz-support.patch"        LOG_STEP_OUT    fifiif $SOURCE_SUPPORT_HOTSPOT_WIFI_6; then    if ! $TARGET_SUPPORT_HOTSPOT_WIFI_6; then        LOG_STEP_IN "- Applying Hotspot Wi-Fi 6 patches"        APPLY_PATCH "system" "system/framework/semwifi-service.jar" "$SRC_DIR/unica/patches/product_feature/wifi/semwifi-service.jar/0004-Disable-Hotspot-6GHz-support.patch"        APPLY_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk" "$SRC_DIR/unica/patches/product_feature/wifi/SecSettings.apk/0003-Disable-Hotspot-Wi-Fi-6.patch"        LOG_STEP_OUT    fifiif $SOURCE_SUPPORT_HOTSPOT_ENHANCED_OPEN; then    if ! $TARGET_SUPPORT_HOTSPOT_ENHANCED_OPEN; then        LOG_STEP_IN "- Applying Hotspot Enhanced Open patches"        APPLY_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk" "$SRC_DIR/unica/patches/product_feature/wifi/SecSettings.apk/0004-Disable-Hotspot-Enhanced-Open.patch"        LOG_STEP_OUT    fifiif ! $SOURCE_AUDIO_SUPPORT_ACH_RINGTONE; then    if $TARGET_AUDIO_SUPPORT_ACH_RINGTONE; then        LOG_STEP_IN "- Applying ACH ringtone patches"        APPLY_PATCH "system" "system/framework/framework.jar" "$SRC_DIR/unica/patches/product_feature/audio/framework.jar/0001-Enable-ACH-ringtone-support.patch"#FOLDER_LIST="#system/media/audio/ringtones#"#for folder in $FOLDER_LIST#do#    DELETE_FROM_WORK_DIR "system" "$folder"#    ADD_TO_WORK_DIR "q7qzcx" "system" "$folder"#done        LOG_STEP_OUT    fifiif $SOURCE_AUDIO_SUPPORT_VIRTUAL_VIBRATION; then    if ! $TARGET_AUDIO_SUPPORT_VIRTUAL_VIBRATION; then        LOG_STEP_IN "Applying virtual vibration patches"        APPLY_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk" "$SRC_DIR/unica/patches/product_feature/audio/SecSettings.apk/0002-Disable-Virtual-Vibration-support.patch"        LOG_STEP_OUT    fifi
